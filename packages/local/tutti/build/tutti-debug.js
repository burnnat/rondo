...
//@require Vex.Flow
//@require Vex.Flow.Music
//@define Vex.Flow.KeyManager
...
//@require Vex.Flow
//@require Vex.Flow.KeyManager
//@define Vex.Flow.Music
// VexFlow - Music Engraving for HTML5
// Copyright Mohit Muthanna 2010
//
...
Vex.Flow.Music = (function() {
     ...
     */
        ...
        getRelativeNoteName: function(root, noteValue) {
            ...
            var i;
            if (interval > 0) {
                for (i = 1; i <= interval; ++i) relativeNoteName += "#";
            } else if (interval < 0) {
                for (i = -1; i >= interval; --i) relativeNoteName += "b";
            }
...
Ext.define('Tutti.Theory', {
    ...
    constructor: function() {
        ...
        var fifths = [];
        var i;
        Ext.Array.forEach(Vex.Flow.Music.accidentals, function(accidental) {
    ...
    getCanonicalNoteName: function(pitch, key) {
        if (!key) {
            ...
            var match = Ext.Array.indexOf(this.FIFTHS_INDEX, pitch, this.getRootOffset(key) - 3);
    ...
    getRootOffset: function(key) {
        ...
        return Ext.Array.indexOf(this.FIFTHS, parts.root + (parts.accidental || '')) - (parts.type == 'M' ? 0 : 3);
    },
    getNoteFromPitch: function(pitch, key) {
        ...
        var adjustment = ((Vex.Flow.Music.root_values[value.root_index] - value.int_val + 1.5 * Vex.Flow.Music.NUM_TONES) % 12) - (Vex.Flow.Music.NUM_TONES / 2);
        return name + '/' + (Math.floor((pitch + adjustment) / 12) - 1);
    },
    getNoteParts: function(note) {
        var split = note.split("/");
        var name = split[0];
        var parts = this.callParent([
                name
            ]);
        parts.name = name;
        if (split.length > 1) {
    ...
    formatNote: function(note) {
        ...
        return note.root.toUpperCase() + accidental.// Ext.String.htmlDecode() only recognizes some entities, so:
    ...
    durationToTicks: function(duration) {
        return new Vex.Flow.Fraction(Vex.Flow.parseNoteData(Vex.Flow.parseNoteDurationString(duration)).ticks, 1);
    },
    /**
    ...
    getMiddleLine: function(clef) {
        ...
        return (Vex.Flow.Music.roots[// The number 6 here calibrates a line shift of 0 to the note "B".
        6 - (lineShift * 2) % scale] + '/' + // The number 4 here calibrates a line shift of 0 to octave 4.
...
Ext.define('Tutti.Util', {
    ...
    move: function(array, oldIndex, newIndex) {
        ...
        Ext.Array.insert(array, newIndex, Ext.Array.splice(array, oldIndex, 1));
    },
    /**
...
Ext.define('Tutti.sync.Conflict', {
    ...
    useLocal: function() {
        ...
        if (remote == null) {
            ...
            proxy.destroy(new Ext.data.Operation({
                action: 'destroy',
                records: [
                    remote
                ],
...
Ext.define('Tutti.proxy.Sync', {
    ...
    create: function(operation) {
        this.updateTracking(this.getCreatedKey(), this.getRemovedKey(), operation.getRecords());
        this.callParent(arguments);
    },
    update: function(operation) {
        var revisionKey = this.getRevisionKey();
        Ext.Array.forEach(operation.getRecords(), function(record) {
    ...
    destroy: function(operation) {
        this.updateTracking(this.getRemovedKey(), this.getCreatedKey(), operation.getRecords());
        this.callParent(arguments);
    },
    ...
    getMaxRevision: function() {
        var revision = parseInt(this.getStorageObject().getItem(this.getMaxRevisionKey()));
    ...
    sync: function(store, callback, scope) {
        ...
        this.getRemoteProxy().read(operation, this.createSyncCallback(store, callback, scope));
    },
    /**
	 * @private
	 * 
    ...
    processSyncResponse: function(operation, store, callback, scope) {
        ...
        Ext.Array.forEach(operation.getRecords(), function(remote) {
            var id = remote.getId();
            ...
            if (local) {
                ...
                if (localRevision == null) {
                    if (remoteRevision > maxRevision) {
                        conflicts.push(new Tutti.sync.Conflict({
                            local: local,
                            remote: remote,
                            store: store,
                            proxy: remoteProxy
        ...
        if (changes.create.length > 0 || changes.update.length > 0 || changes.destroy.length > 0) {
            Ext.Logger.info("Persisting local changes for store '" + store.getStoreId() + "': " + changes.create.length + " creations, " + changes.update.length + " updates, " + changes.destroy.length + " deletions");
            this.getRemoteProxy().batch({
                operations: changes,
                listeners: {
                    complete: Ext.bind(this.onBatchSyncComplete, this, [
                        store,
                        callback,
                        scope
                    ], 0),
...
Ext.define('Tutti.proxy.RestSync', {
    ...
    updateId: function(id) {
        this.setRemoteProxy(new Tutti.proxy.Rest({
            url: '/api/' + id,
            reader: {
                type: 'json',
...
Ext.define('Tutti.proxy.Store', {
    ...
    read: function(operation, callback, scope) {
        var store = this.getStore();
        var filters = Ext.Array.map(operation.getFilters() || [], function(filter) {
                return filter.getFilterFn();
            });
        var matches = store.queryBy(function(record) {
                return Ext.Array.every(filters, function(filter) {
...
Ext.define('Tutti.sync.Manager', {
    ...
    register: function(store) {
        ...
        model.getAssociations().each(function(association) {
        ...
        Ext.Object.each(this.dependencies, function(parent, children) {
            if (parent === modelName) {
    ...
    syncNext: function() {
        ...
        Ext.Object.each(sessionDeps, function(storeId, prereqs) {
            if (prereqs.length === 0) {
                delete sessionDeps[storeId];
                var store = Ext.getStore(storeId);
                store.getProxy().sync(store, me.onSyncComplete, me);
            }
        });
    },
    /**
    ...
    onSyncComplete: function(proxy, store) {
        ...
        var empty = true;
        Ext.Object.each(session.prereqs, function(store, array) {
            empty = false;
...
//@define Vex.Min
//@define Vex.RoundN
//@define Vex.RuntimeError
//@define Vex.SortAndUnique
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
//@require Vex.Flow
//@require Vex.Flow.Fraction
//@require Vex.Flow.Modifier
//@require Vex.Flow.Music
//@require Vex.Inherit
//@define Vex.Flow.Accidental
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
...
Vex.Flow.Accidental = (function() {
    ...
    Accidental.format = function(accidentals, state) {
        ...
        var line_list = [];
        // an array of unique line numbers
        var acc_shift = 0;
        // amount by which all accidentals must be shifted right or left for stem flipping, notehead shifting concerns.
        ...
        for (i = 0; i < line_list.length; i++) {
            ...
            } else // Otherwise, if the group contains fewer than seven members, use the layouts from
    ...
    Accidental.checkCollision = function(line_1, line_2) {
        ...
        if (clearance > 0) {
            ...
            clearance_required = (line_2.flat_line || line_2.dbl_sharp_line) ? 2.5 : 3;
            ...
            // line 1 is on top
            clearance_required = (line_1.flat_line || line_1.dbl_sharp_line) ? 2.5 : 3;
        ...
        voices.forEach(function(voice) {
            ...
            notes.forEach(function(note) {
                ...
                if (!notesAtPosition) {
                    ...
                    tickNoteMap[tickPosition.value()] = [
                        note
                    ];
                } else {
...
Vex.Flow.Tickable = (function() {
    ...
    Tickable.prototype = {
        init: function() {
            ...
            // Shift from tick context if center aligned
...
//@require Vex.Flow
//@require Vex.Flow.Tickable
//@require Vex.Inherit
//@require Vex.RuntimeError
//@define Vex.Flow.Note
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
Vex.Flow.Note = (function() {
    ...
    Vex.Inherit(Note, Vex.Flow.Tickable, {
        ...
        init: function(note_struct) {
            ...
            this.width = 0;
            // Width in pixels calculated after preFormat
            this.extraLeftPx = 0;
            // Extra room on left for offset note head
            this.extraRightPx = 0;
            // Extra room on right for offset note head
            this.x_shift = 0;
            // X shift from tick context X
            this.left_modPx = 0;
            // Max width of left modifiers
            this.right_modPx = 0;
            // Max width of right modifiers
            this.voice = null;
            // The voice that this note is in
            this.preFormatted = false;
            // Is this note preFormatted?
            this.ys = [];
            // list of y coordinates for each note
        ...
        setStave: function(stave) {
            ...
            // Update Y values if the stave is changed.
...
//@require Vex.Flow
//@require Vex.Flow.BoundingBox
//@require Vex.Flow.Note
//@require Vex.Inherit
//@require Vex.Merge
//@require Vex.RuntimeError
//@define Vex.Flow.NoteHead
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
//@require Vex.Flow
//@require Vex.Flow.Note
//@require Vex.Flow.Stem
//@require Vex.Inherit
//@require Vex.Max
//@require Vex.Min
//@define Vex.Flow.StemmableNote
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
//@require Vex.Flow
//@require Vex.Flow.BoundingBox
//@require Vex.Flow.Dot
//@require Vex.Flow.NoteHead
//@require Vex.Flow.Stem
//@require Vex.Flow.StemmableNote
//@require Vex.Inherit
//@require Vex.Max
//@require Vex.Merge
//@require Vex.MidLine
...
Vex.Flow.StaveNote = (function() {
    ...
    Vex.Inherit(StaveNote, Vex.Flow.StemmableNote, {
        ...
        addDotToAll: function() {
            for (var i = 0; i < this.keys.length; ++i) this.addDot(i);
            return this;
        },
...
//@require Vex.Flow
//@require Vex.Flow.Modifier
//@require Vex.Flow.StaveNote
//@require Vex.Inherit
//@define Vex.Flow.Articulation
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
// Author: Larry Kuhns.
//
// ## Description
...
Vex.Flow.Articulation = (function() {
    ...
    Articulation.format = function(articulations, state) {
        ...
        for (var i = 0; i < articulations.length; ++i) {
            ...
            width = articulation.getWidth() > max_width ? articulation.getWidth() : max_width;
...
//@require Vex.Flow
//@require Vex.Flow.StaveModifier
//@require Vex.Inherit
//@define Vex.Flow.Barline
// Vex Flow Notation
...
//@require Vex.Flow
//@require Vex.Flow.Barline
//@require Vex.Flow.BoundingBox
//@require Vex.Flow.Note
//@require Vex.Inherit
//@define Vex.Flow.BarNote
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
Vex.Flow.BarNote = (function() {
    ...
    Vex.Inherit(BarNote, Vex.Flow.Note, {
        init: function() {
            BarNote.superclass.init.call(this, {
                duration: "b"
            });
...
//@require Vex.Flow
//@require Vex.Flow.Font
//@require Vex.Merge
//@require Vex.RuntimeError
//@define Vex.Flow.Glyph
// Vex Flow
// Mohit Muthanna <mohit@muthanna.com>
//
// Copyright Mohit Muthanna 2010
...
//@require Vex.Flow
//@require Vex.Flow.Glyph
//@require Vex.Flow.Stem
//@require Vex.Merge
//@require Vex.RuntimeError
//@define Vex.Flow.Tuplet
/**
...
//@require Vex.Flow.Fraction
//@require Vex.Flow.Stem
//@require Vex.Flow.Tuplet
//@require Vex.RuntimeError
//@define Vex.Flow.Beam
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
Vex.Flow.Beam = (function() {
        ...
        getBeamLines: function(duration) {
            ...
            for (var i = 0; i < this.notes.length; ++i) {
                ...
                if (ticks < Vex.Flow.durationToTicks(duration)) {
                    ...
                    if (!beam_started) {} else // we don't care
                    {
                        current_beam = beam_lines[beam_lines.length - 1];
    ...
    Beam.getDefaultBeamGroups = function(time_sig) {
        ...
        if (!groups) {
            ...
            if (tripleMeter) {
                return [
                    new Fraction(3, beatValue)
                ];
            } else if (beatValue > 4) {
                return [
                    new Fraction(2, beatValue)
                ];
            } else if (beatValue <= 4) {
                return [
                    new Fraction(1, beatValue)
                ];
            }
        } else {
    ...
    Beam.generateBeams = function(notes, config) {
        ...
        function createGroups() {
            ...
            unprocessedNotes.forEach(function(unprocessedNote) {
                ...
                // Ignore untickables (like bar notes)
...
//@require Vex.Flow
//@require Vex.Flow.BoundingBox
//@require Vex.Flow.Clef
//@require Vex.Flow.Glyph
//@require Vex.Flow.Note
//@require Vex.Inherit
//@define Vex.Flow.ClefNote
// Vex Flow Notation
// Copyright Mohit Muthanna 2010
//
...
Vex.Flow.ClefNote = (function() {
    ...
    Vex.Inherit(ClefNote, Vex.Flow.Note, {
        init: function(clef, size, annotation) {
            ClefNote.superclass.init.call(this, {
                duration: "b"
            });
...
Vex.Flow.TickContext = (function() {
    ...
    TickContext.prototype = {
        init: function() {
            ...
            this.width = 0;
            this.padding = 3;
            // padding on each side (width += padding * 2)
            this.pixelsUsed = 0;
            this.x = 0;
            this.tickables = [];
            ...
            this.extraLeftPx = 0;
            // Extra left pixels for modifers & displace notes
            this.extraRightPx = 0;
            // Extra right pixels for modifers & displace notes
            this.align_center = false;
            this.tContexts = [];
            // Parent array of tick contexts
...
//@require Vex.Flow
//@require Vex.Flow.Note
//@require Vex.Flow.TickContext
//@require Vex.Inherit
//@require Vex.Merge
//@define Vex.Flow.Crescendo
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
//@require Vex.Flow.Modifier
//@require Vex.Inherit
//@define Vex.Flow.FretHandFinger
// VexFlow - Music Engraving for HTML5
// Copyright Mohit Muthanna 2010
...
Vex.Flow.FretHandFinger = (function() {
    ...
    Vex.Inherit(FretHandFinger, Modifier, {
        init: function(number) {
            ...
            this.width = 7;
            this.position = Modifier.Position.LEFT;
            // Default position above stem or note head
            this.x_shift = 0;
            this.y_shift = 0;
            this.x_offset = 0;
            // Horizontal offset from default
            this.y_offset = 0;
            // Vertical offset from default
            this.font = {
                family: "sans-serif",
                size: 9,
                weight: "bold"
...
//@require Vex.Flow
//@require Vex.Flow.Beam
//@require Vex.Flow.Formatter
//@require Vex.Flow.Modifier
//@require Vex.Flow.StaveTie
//@require Vex.Flow.Voice
//@require Vex.Inherit
//@require Vex.RuntimeError
//@define Vex.Flow.GraceNoteGroup
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
Vex.Flow.Ornament = (function() {
    ...
    Ornament.format = function(ornaments, state) {
        ...
        for (var i = 0; i < ornaments.length; ++i) {
            ...
            width = ornament.getWidth() > max_width ? ornament.getWidth() : max_width;
...
//@require Vex.Flow
//@define Vex.Flow.RaphaelContext
// Vex Flow
// Mohit Muthanna <mohit@muthanna.com>
//
// A rendering context for the Raphael backend.
...
//@require Vex.Flow
//@require Vex.Flow.CanvasContext
//@require Vex.Flow.RaphaelContext
//@require Vex.Flow.SVGContext
//@define Vex.Flow.Renderer
// Vex Flow
// Mohit Muthanna <mohit@muthanna.com>
//
...
//@require Vex.Flow
//@require Vex.Flow.Modifier
//@require Vex.Flow.Renderer
//@require Vex.Flow.StaveNote
//@require Vex.Inherit
//@define Vex.Flow.StringNumber
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
// Author: Larry Kuhns
//
// ## Description
...
Vex.Flow.StringNumber = (function() {
    ...
    Vex.Inherit(StringNumber, Modifier, {
        init: function(number) {
            ...
            // Vertical offset from default
            this.dashed = true;
            // true - draw dashed extension  false - no extension
            this.leg = Vex.Flow.Renderer.LineEndType.NONE;
            // draw upward/downward leg at the of extension line
            this.radius = 8;
            this.font = {
                family: "sans-serif",
                size: 10,
        ...
        draw: function() {
            ...
            if (this.last_note != null) {
                ...
                ctx.lineWidth = 0.6;
                if (this.dashed)  {
                    Vex.Flow.Renderer.drawDashedLine(ctx, dot_x + 10, dot_y, dot_x + end, dot_y, [
                        3,
                        3
                    ]);
                }
...
//@require Vex.Flow
//@require Vex.Flow.Bend
//@require Vex.Flow.Modifier
//@require Vex.Inherit
//@define Vex.Flow.Vibrato
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
//@require Vex.Flow
//@require Vex.Flow.Accidental
//@require Vex.Flow.Annotation
//@require Vex.Flow.Articulation
//@require Vex.Flow.Bend
//@require Vex.Flow.Dot
//@require Vex.Flow.FretHandFinger
//@require Vex.Flow.GraceNoteGroup
//@require Vex.Flow.Ornament
//@require Vex.Flow.StaveNote
//@require Vex.Flow.StringNumber
//@require Vex.Flow.Stroke
//@require Vex.Flow.Vibrato
//@define Vex.Flow.ModifierContext
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
//@require Vex.Flow
//@require Vex.Merge
//@define Vex.Flow.StaveConnector
// Vex Flow Notation
// Mohit Muthanna <mohit@muthanna.com>
//
// Copyright Mohit Muthanna 2010
...
Vex.Flow.StaveConnector = (function() {
    ...
    StaveConnector.prototype = {
        ...
        // Mainly used to offset Bold Double Left to align with offset Repeat Begin bars
    ...
    function drawBoldDoubleLine(ctx, type, topX, topY, botY) {
        ...
        // Width for avoiding anti-aliasing width issues
        var thickLineOffset = 2;
        // For aesthetics
        if (type === StaveConnector.type.BOLD_DOUBLE_RIGHT) {
            x_shift = -5;
            // Flips the side of the thin line
            variableWidth = 3;
        }
        // Thin line
...
//@require Vex.Flow.Beam
//@require Vex.Flow.Fraction
//@require Vex.Flow.ModifierContext
//@require Vex.Flow.StaveConnector
//@require Vex.Flow.StaveNote
//@require Vex.Flow.TickContext
//@require Vex.Max
//@require Vex.Merge
//@require Vex.MidLine
//@require Vex.Min
//@require Vex.SortAndUnique
//@define Vex.Flow.Formatter
// [VexFlow](http://vexflow.com) - Copyright (c) Mohit Muthanna 2010.
//
// ## Description
//
...
Vex.Flow.Formatter = (function() {
    ...
    Formatter.prototype = {
        ...
        preFormat: function(justifyWidth, rendering_context, voices, stave) {
            ...
            var white_space = 0;
            // White space to right of previous note
            var tick_space = 0;
            // Pixels from prev note x-pos to curent note x-pos
            var prev_tick = 0;
            var prev_width = 0;
...
//@require Vex.Flow.Clef
//@require Vex.Flow.Glyph
//@require Vex.Flow.KeySignature
//@require Vex.Flow.Repetition
//@require Vex.Flow.StaveSection
//@require Vex.Flow.StaveTempo
//@require Vex.Flow.StaveText
//@require Vex.Flow.TimeSignature
//@require Vex.Flow.Volta
//@require Vex.Merge
//@define Vex.Flow.Stave
// Vex Flow
// Mohit Muthanna <mohit@muthanna.com>
//
// Copyright Mohit Cheppudira 2010
...
Vex.Flow.Stave = (function() {
    ...
    Stave.prototype = {
        init: function(x, y, width, options) {
            ...
            this.end_glyphs = [];
            this.modifiers = [];
            // non-glyph stave items (barlines, coda, segno, etc.)
            this.measure = 0;
            this.clef = "treble";
            this.font = {
                family: "sans-serif",
...
//@require Vex.Flow
//@require Vex.Flow.TabTie
//@require Vex.Inherit
//@define Vex.Flow.TabSlide
// VexFlow - Music Engraving for HTML5
// Copyright Mohit Muthanna 2010
//
// This class implements varies types of ties between contiguous notes. The
...
//@require Vex.Flow
//@require Vex.Flow.Glyph
//@require Vex.Flow.Stave
//@require Vex.Inherit
//@require Vex.Merge
//@define Vex.Flow.TabStave
// Vex Flow
// Mohit Muthanna <mohit@muthanna.com>
//
// Copyright Mohit Cheppudira 2010
    ...
    Vex.Inherit(TextNote, Vex.Flow.Note, {
        ...
        preFormat: function() {
            ...
            if (this.smooth) {
                ...
                if (this.glyph) {} else // Width already set.
                {
...
Vex.Flow.TimeSigNote = (function() {
    ...
    Vex.Inherit(TimeSigNote, Vex.Flow.Note, {
        init: function(timeSpec, customPadding) {
            TimeSigNote.superclass.init.call(this, {
                duration: "b"
            });
